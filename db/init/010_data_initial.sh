...
psql -v ON_ERROR_STOP=1 -U "${POSTGRES_USER}" -d "${POSTGRES_DB}" <<-EOF
 ...
 INSERT INTO transactions (created, amount, title, details, state, legal_type, flow_type, project_id, category_id, producer_bank_id, consumer_bank_id, producer_account, consumer_account, consumer_tin, consumer_tel) values (now() - interval '2 day', 12000, 'Оплата кривого счета №65', 'Платеж может вернуться', 'returned', 'private', 'expense', (select id from projects where name = 'Euro'), (select id from transaction_categories where title = 'Внутренние переводы'), (select id from banks where reg = 1326), (select id from banks where reg = 3036), '40702810951005011596', '40702810217212980769', '589157094093', '73948974559'); 
 INSERT INTO transactions (created, amount, title, details, state, legal_type, flow_type, project_id, category_id, producer_bank_id, consumer_bank_id, producer_account, consumer_account, consumer_tin, consumer_tel) values (now() - interval '20 day', 12000, 'Оплата старого счета №5', 'Канцелярка', 'fulfilled', 'private', 'expense', (select id from projects where name = 'Euro'), (select id from transaction_categories where title = 'Внутренние переводы'), (select id from banks where reg = 1326), (select id from banks where reg = 3036), '40702810365771199092', '40702810668515143794', '016689259514', '78985711973');
 INSERT INTO transactions (created, amount, title, details, state, legal_type, flow_type, project_id, category_id, producer_bank_id, consumer_bank_id, producer_account, consumer_account, consumer_tin, consumer_tel) values (now() - interval '20 day', 12000, 'Оплата счета №1', 'Аналитика', 'canceled', 'private', 'expense', (select id from projects where name = 'Euro'), (select id from transaction_categories where title = 'Внутренние переводы'), (select id from banks where reg = 3505), (select id from banks where reg = 2273), '40702810365771199092', '40702810668515143794', '016689259514', '78985711973'); 
 INSERT INTO transactions (created, amount, title, details, state, legal_type, flow_type, project_id, category_id, producer_bank_id, consumer_bank_id, producer_account, consumer_account, consumer_tin, consumer_tel) values (now() - interval '22 day', 12000, 'Оплата счета №1', 'Поставки', 'deleted', 'private', 'expense', (select id from projects where name = 'Euro'), (select id from transaction_categories where title = 'Внутренние переводы'), (select id from banks where reg = 3505), (select id from banks where reg = 2273), '40702810365771199092', '40702810668515143794', '314752180707', '76337827355');
 INSERT INTO transactions (created, amount, title, details, state, legal_type, flow_type, project_id, category_id, producer_bank_id, consumer_bank_id, producer_account, consumer_account, consumer_tin, consumer_tel) values (now() - interval '20 day', 12000, 'Оплата счета №1', 'Аналитика', 'canceled', 'private', 'expense', (select id from projects where name = 'Euro'), (select id from transaction_categories where title = 'Внутренние переводы'), (select id from banks where reg = 3505), (select id from banks where reg = 2273), '40702810365771199092', '40702810668515143794', '016689259514', '78985711973');
 ...
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '1 day', 10000000, 'Salary for last month', (select id from projects where name = 'Exchange'), (select id from income_categories where title = 'Salary'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '5 day', 5000000, 'Stocks income', (select id from projects where name = 'Exchange'), (select id from income_categories where title = 'Salary'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '10 day', 200000000, 'Annual bonus', (select id from projects where name = 'Exchange'), (select id from income_categories where title = 'Salary'));

 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '4 day', 100000000, 'Transfer from export account', (select id from projects where name = 'Incomes'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '7 day', 250000000, 'Oil export transfer', (select id from projects where name = 'Incomes'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '11 day', 500000000, 'Diamonds income transfer', (select id from projects where name = 'Incomes'), (select id from income_categories where title = 'Transfer'));

 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '3 day', 2000000, 'Transfer for day-to-day spents', (select id from projects where name = 'Spendings'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '8 day', 2500000, 'Transfer for jet rental', (select id from projects where name = 'Spendings'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '12 day', 5000000, 'Transfer for pizza in Rome', (select id from projects where name = 'Spendings'), (select id from income_categories where title = 'Transfer'));

 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '4 day', 10000000, 'MBA payment', (select id from projects where name = 'Exchange'), (select id from expense_categories where title = 'Education'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '6 day', 5000000, 'Python course', (select id from projects where name = 'Exchange'), (select id from expense_categories where title = 'Education'));

 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '11 day', 10000000, 'Visit to Rome', (select id from projects where name = 'Incomes'), (select id from expense_categories where title = 'Journeys'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '12 day', 12000000, 'Visit to US', (select id from projects where name = 'Incomes'), (select id from expense_categories where title = 'Journeys'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '15 day', 21000000, 'Visit to Voronej', (select id from projects where name = 'Incomes'), (select id from expense_categories where title = 'Journeys'));

 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '1 day', 100000, 'Kroshka-kortoshka', (select id from projects where name = 'Spendings'), (select id from expense_categories where title = 'Other'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '2 day', 120000, 'Civiar', (select id from projects where name = 'Spendings'), (select id from expense_categories where title = 'Other'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '4 day', 130000, 'Fuagra', (select id from projects where name = 'Spendings'), (select id from expense_categories where title = 'Other'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '7 day', 230000, 'Wildberries', (select id from projects where name = 'Spendings'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '12 day', 220000, 'Ozon', (select id from projects where name = 'Spendings'), (select id from expense_categories where title = 'Shopping'));

 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '6 day', 1000000, 'Salary for last month', (select id from projects where name = 'Rubble'), (select id from income_categories where title = 'Salary'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '9 day', 500000, 'Sashka return debt', (select id from projects where name = 'Rubble'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '11 day', 20000000, 'Found in the club', (select id from projects where name = 'Rubble'), (select id from income_categories where title = 'Transfer'));

 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '1 day', 100000, 'Gift from grandma', (select id from projects where name = 'Dollars'), (select id from income_categories where title = 'Gift'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '2 day', 500000, 'Won pizza-eating competition', (select id from projects where name = 'Dollars'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '6 day', 2000000, 'Gift from grandpa', (select id from projects where name = 'Dollars'), (select id from income_categories where title = 'Gift'));

 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '3 day', 100000, 'Last sallary from Microsoft', (select id from projects where name = 'Euro'), (select id from income_categories where title = 'Salary'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '7 day', 150000, 'Casino wins', (select id from projects where name = 'Euro'), (select id from income_categories where title = 'Transfer'));
 INSERT INTO incomes (created, amount, title, project_id, category_id) values (now() - interval '12 day', 120000, 'Mom transfer', (select id from projects where name = 'Euro'), (select id from income_categories where title = 'Gift'));

 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '5 day', 10000, 'Newspaper', (select id from projects where name = 'Rubble'), (select id from expense_categories where title = 'Other'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '6 day', 12000, 'Watter and cookies', (select id from projects where name = 'Rubble'), (select id from expense_categories where title = 'Other'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '7 day', 13000, 'Shaurma on Savelovskay station', (select id from projects where name = 'Rubble'), (select id from expense_categories where title = 'Other'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '8 day', 230000, 'Pyaterochka', (select id from projects where name = 'Rubble'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '9 day', 120000, 'Krasnoe-and-beloye', (select id from projects where name = 'Rubble'), (select id from expense_categories where title = 'Shopping'));

 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '2 day', 20000, 'Disco', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Entertainment'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '3 day', 120000, 'Night clud', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Entertainment'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '4 day', 630000, 'Bar', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Entertainment'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '6 day', 3300000, 'Hot night', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Entertainment'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '8 day', 9200000, 'Visit to Piter', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Entertainment'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '10 day', 130000, 'TV', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '11 day', 3300000, 'Mustang GT', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '15 day', 520000, 'Turbo jet pack', (select id from projects where name = 'Dollars'), (select id from expense_categories where title = 'Shopping'));

 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '10 day', 33000, 'PS 5', (select id from projects where name = 'Euro'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '11 day', 42000, 'iPhone Pro 23 max', (select id from projects where name = 'Euro'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '12 day', 65000, 'MacBook pro 15', (select id from projects where name = 'Euro'), (select id from expense_categories where title = 'Shopping'));
 INSERT INTO expenses (created, amount, title, project_id, category_id) values (now() - interval '13 day', 23000, 'Tesla subscription', (select id from projects where name = 'Euro'), (select id from expense_categories where title = 'Shopping'));
EOF
